...
function M.get_colors(base, theme_name)
    local path = "teebowie.plugins.base46.hl_themes." .. theme_name
...
function M.load_theme(user_opts)
    ...
    -- term hls
    require("teebowie.plugins.base46.base46_term").set_hls(colors)

    -- get hls
    local hls = require("teebowie.plugins.base46.base46_hls").get_hls(colors, opts.transparency)
